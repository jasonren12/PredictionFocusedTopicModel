...
def main():
    ...
    parser.add_argument(
        "--p", type=float, default=0.15, help="Value for the switch prior for pf-sLDA"
    )
    parser.add_argument(
        "--alpha", type=bool, default=True, help="Specify if alpha is fixed"
    )
    parser.add_argument(
        "--path",
        type=str,
    ...
    parser.add_argument(
        "--lambd", type=float, default=0, help="Supervised task regularizer weight"
    )
    parser.add_argument(
