...
class sLDA(nn.Module):
    ...
    def ELBO(self, W_batch, phi_batch, gamma_batch, y_batch, version="real"):
        ...
        third_term = contract("mkv,mv,kv->", phi, W_batch, beta.log(), backend="torch")
        ...
        fifth_term = contract("mkv,mkv,mv->", phi, phi.log(), W_batch, backend="torch")
        ...
        return first_term + second_term + third_term - fourth_term - fifth_term + s_term
